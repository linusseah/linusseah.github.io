...
Using the pipeline function and 3 different Naive Bayes models, I passed on these pipelines along with different parameters into a parameter tuning function that I have also shared below. 
...
Here is the class function that helped to parameter tune for various Naive Bayes models using GridSearch and to output results in an easily digestible dataframe format. 
