...
## Useful Resources:
1. [TextBlob](https://textblob.readthedocs.io/en/dev/quickstart.html#part-of-speech-tagging){:target="_blank"}
2. [Spacy](https://spacy.io/api/annotation#pos-tagging){:target="_blank"}
3. [Gensim](https://www.machinelearningplus.com/nlp/topic-modeling-gensim-python/){:target="_blank"}
4. [Flask Deployment](https://www.bogotobogo.com/python/Flask/Python_Flask_Embedding_Machine_Learning_3.php){:target="_blank"}
5. [Heroku Deployment](https://towardsdatascience.com/designing-a-machine-learning-model-and-deploying-it-using-flask-on-heroku-9558ce6bde7b){:target="_blank"}
...
3. Project inspiration from [Heidi](https://heidicq.github.io//capstone/){:target="_blank"}
