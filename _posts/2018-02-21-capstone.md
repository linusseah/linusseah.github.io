...
(current aim to build a model that is optimized for text input of up to a few sentences long) 
...
# Tuning Baseline Model & Fitting on Alternative Models  
...
# Using Lexcial Rule Based Libraries For Sentiment Analysis and Text Mining 
...
# Combining different functions for Deployment 
...
You can take a look at my Jupyter notebook on my personal Github (https://github.com/linusseah/General-DataScience-Projects-/tree/master/capstone) for a more comprehensive step-by-step breakdown of how I built up the combined function. 

# Deploying Locally on Flask
...
# Deploying Externally on Heroku 

The final stage of the project involved deploying the flask-app on the internet and exposing the web-application to the world! (beyond the lonely confines of my laptop screen)  
...
You can view version 1 and 2 of the deployed application at the following links:
Version 1: https://inside-out-emotions.herokuapp.com/results
Version 2: https://inside-out2.herokuapp.com/?
