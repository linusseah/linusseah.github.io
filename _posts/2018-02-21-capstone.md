...
## Proposed Solution 
A web-application that provides sentence specific emotional analysis and associated key-words/phrases when given textual input

(current model is built for text input of up to a few paragraphs long) 
