...
`EstimatorSelectionHelper` contains a `.fit` function that takes in the predictor and target variables and passes them onto `SKlearn's GridSearchCV function` to generate scores for different model-parameter combinations.
