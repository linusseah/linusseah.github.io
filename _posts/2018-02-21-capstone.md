...
---
# Background  
> For most of us, experiencing, intepreting, understanding and reacting to our own emotional states and those around us are very much a part of our daily interactions at the workplace, at home with our parents and so on; reacting appropriately to different situations based on the emotional context is key to personal / business etc success. However it is difficult to gather emotional feedback at scale OR when it is based on largely unstructured forms on input (like text). 

The following are some examples of potential use cases for emotional classification: 
